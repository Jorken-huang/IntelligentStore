...
namespace IntelligentStore.Pages
{
    ...
    public sealed partial class MainPage : Page
    {
        public MainPage()
        {
            ...
            videoFrame.Navigate(typeof(Video));
        }
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
                ...
                viewModel.ComputerStore(gvComputer);
                viewModel.PhoneStore(gvPhone);
                viewModel.GameStore(gvGame);                
        }
        ...
        {
            Frame.Navigate(typeof(MobiePhone));
        }
        ...
        private void gvComputer_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
